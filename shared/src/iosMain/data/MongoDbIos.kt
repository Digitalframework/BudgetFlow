...
/**
 * MongoDB Realm implementation for iOS platform.
 * Uses MongoDB Atlas Device SDK for local persistence and sync.
 */
class MongoDbIos : TransactionRepo {
...
/**
 * Factory function to create repository for iOS.
 */
fun createTransactionRepository(): TransactionRepo {
    return MongoDbIos()
}